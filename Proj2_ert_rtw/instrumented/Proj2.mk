...
## 
## Makefile     : Proj2.mk
## Generated on : Fri Feb 13 19:10:21 2026
...
SRCS = $(START_DIR)/Proj2_ert_rtw/instrumented/Proj2.c $(START_DIR)/Proj2_ert_rtw/instrumented/Proj2_data.c

MAIN_SRC = $(START_DIR)/Proj2_ert_rtw/instrumented/ert_main.c
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) $(subst /,\,$(OBJS)) $(subst /,\,$(MAIN_OBJ)) $(subst /,\,$(SYSTEM_LIBS)) $(subst /,\,$(TOOLCHAIN_LIBS))
...
Proj2.o : $(START_DIR)/Proj2_ert_rtw/instrumented/Proj2.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


Proj2_data.o : $(START_DIR)/Proj2_ert_rtw/instrumented/Proj2_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/Proj2_ert_rtw/instrumented/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
